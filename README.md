...
Build and install the self-contained CLI from this repository:

```bash
git clone https://github.com/MildyNora/NetworkSandbox.git
cd NetworkSandbox
...
model, and
[docs/macos-isolation-research.md](docs/macos-isolation-research.md) for the
